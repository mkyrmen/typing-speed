      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-lg font-mono transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 ${
              isActive
